        ...
        if (productRepository.count() == 0) {
            productRepository.saveAll(Arrays.asList(
                Product.builder()
                    ...
                    .imageUrl("/images/item_y2k_sticker.png")
                ...
                Product.builder()
                    ...
                    .imageUrl("/images/item_sailor_girl.png")
                ...
                Product.builder()
                    ...
                    .imageUrl("/images/item_clover_cat.png")
                    .category(Category.STICKER)
                    .stock(300)
                    .build(),
                Product.builder()
                    ...
                    .imageUrl("/images/item_kotatsu.png")
                ...
                Product.builder()
                    ...
                    .imageUrl("/images/item_acorn_girl.png")
                    .category(Category.NOTE)
                    .stock(80)
                    .build(),
                Product.builder()
                    ...
                    .imageUrl("/images/item_ramen_girl.png")
                ...
                Product.builder()
                    ...
                    .imageUrl("/images/item_mic_girl.png")
                    .category(Category.STICKER)
                    .stock(200)
                    .build()
            ));
